 ...
 *
 * Revision: $Id: $.autocomplete.js 15 2009-08-22 10:30:27Z joern.zaefferer $
 */
//@ sourceURL=jquery.autocomplete.min.js
	...
	$.Autocompleter.Select = function(options, input, select, config) {
		...
		function init() {
			...
			element = $("<div/>").hide().addClass(options.resultsClass).css(
					{"position":"absolute","background-color":"white"}).appendTo(document.body);
			list = $("<ul/>")
					.appendTo(element)
					.mouseover(
							function(event) {
