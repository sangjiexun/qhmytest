...
(function($, window) {
	...
	$("#btn_tzzy").click(function(){
		var pkids=stu.getIdSelections();
		//学生类型pkid拼接
		var xslxpkidss=stu.getXSLXPKIDSelections()+"";
		//转换成数组
		var xslxpkidssArrays = xslxpkidss.split(",");
		//取第一个学生类型pkid
		var xslxpkid = xslxpkidssArrays[0];
		//循环比较如果拼接的pkid不相同则提示
		for(var i = 0;i<xslxpkidssArrays.length;i++){
			if(xslxpkid!=xslxpkidssArrays[i]){
				layer.msg("所选学生专业的学生类型必须相同!");
				return false;
			}
		}
		var czid = $("input[name='id']:checked").val();
								...
								columns : [
									...
									
									{
										...
										formatter : function(value, row,
											...
											if(row.IS_TONGGUO == '1'){//表示审核通过
												return [
												        SESSION_MENU_BUTTONS.xslb_gjtz == 1?'<a class="highEdit ml10" href="javascript:void(0)" title="高级调整"><i class="fa fa-exchange"></i></a>&nbsp;&nbsp;':'',
														SESSION_MENU_BUTTONS.xslb_sc == 1?'<a class="cancel ml10" href="javascript:void(0)" title="删除"><i class="fa fa-trash-o"></i></a>&nbsp;&nbsp;':'' ]
														.join('');
											}else{
												return [
												        SESSION_MENU_BUTTONS.xslb_bj == 1?'<a class="edit ml10" href="javascript:void(0)" title="修改"><i class="fa fa-pencil" ></i></a>&nbsp;&nbsp;':'',
												        SESSION_MENU_BUTTONS.xslb_gjtz == 1?'<a class="highEdit ml10" href="javascript:void(0)" title="高级调整"><i class="fa fa-exchange"></i></a>&nbsp;&nbsp;':'',
												        SESSION_MENU_BUTTONS.xslb_sc == 1?'<a class="cancel ml10" href="javascript:void(0)" title="删除"><i class="fa fa-trash-o"></i></a>&nbsp;&nbsp;':'',
