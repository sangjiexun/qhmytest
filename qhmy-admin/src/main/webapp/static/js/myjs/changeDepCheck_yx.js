										...
										formatter : function(value, row, index) {
											if(row.CHECK_STATUS=='待审核'){
												return [
												        ...
												        SESSION_MENU_BUTTONS.tzzysh_tg_yx == 1?'<span title="通过" class="glyphicon glyphicon-ok pass" style=" cursor:pointer;"></span>&nbsp;&nbsp;':'',
												        		SESSION_MENU_BUTTONS.tzzysh_btg_yx == 1?'<span title="不通过" class="glyphicon glyphicon-remove dispass" style=" cursor:pointer;"></span>':'']
												.join('');
											}else{
												return [
												        '<span title="查看" class="fa fa-search detail" style=" cursor:pointer;"></span>&nbsp;&nbsp;']
