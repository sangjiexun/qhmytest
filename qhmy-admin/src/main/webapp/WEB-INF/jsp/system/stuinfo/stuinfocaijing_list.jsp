...
<!-- 	     <script type="text/javascript" src="${basepath}static/js/myjs/stu_ztree.js"></script> -->
	    ...
	    <script type="text/javascript" src="${basepath}static/js/myjs/stuinfocaijing.js"></script>
	    <style type="text/css">
		...
		<div class="form-inline" style="margin-bottom: 15px;">
			...
			<input type="text" class="form-control" style="width:75px;" placeholder="投档成绩区间止" id="TOUDANGCHENGJIZHI"/>
			    <!-- <select name="" class="form-control jf_FltConditions" id="stu_zhuanduan">
                   <option value="">转段标识</option>
                   <option value="WZN">外转内</option>
		   		</select> -->
		</form>
		</div>
		<c:if test="${SESSION_MENU_BUTTONS.xslb_xz == '1' }">
		...
		<c:if test="${SESSION_MENU_BUTTONS.xslb_drxg == '1' }">
