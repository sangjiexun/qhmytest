...
%>
		...
		<script type="text/javascript" src="${basepath}static/js/myjs/diviDorm_ztree.js"></script>
		                 ...
		                 <div class="zTreeDemoBackground left">
							<ul class="list" style="margin-bottom:0;">
								<li class="jf_ZtLaber title"><input class="form-control" id="citySel3" type="text" readonly value="" onclick="showMenu3();" placeholder="请选择宿舍"/>
									<div id="menuContent3" class="jf_ZtBox menuContent" style="width:300px;max-height:200px; overflow:auto">
