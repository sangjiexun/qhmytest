...
<html>
	...
	<body>
		<div class="form-inline">
			<input type="text"  id="DATESTART" class="laydate-icon form-control" value="${pd.DATESTART}" placeholder="操作时间起" readonly="readonly"  /> ~
			<input type="text"  id="DATEEND" class="laydate-icon form-control" value="${pd.DATEEND}" placeholder="操作时间止" readonly="readonly"  />
	...
	<script type="text/javascript" src="${basepath}static/js/myjs/recordOfCostChanges.js"></script>
