...
%>
		...
		<div style="margin-left:10px;">
			...
			<div class="row clearfix">
				<div class="col-md-12 column">
					<!-- 选择文件按钮 -->
					<button id="i_select_files" type="button" class="btn btn-danger" style="margin-right:5px;float:left;margin-bottom:15px;"/>
					<!-- end 选择文件按钮 -->
		...
		<script type="text/javascript" src="${basepath }static/js/myjs/import/importdorminfo.js"></script>
