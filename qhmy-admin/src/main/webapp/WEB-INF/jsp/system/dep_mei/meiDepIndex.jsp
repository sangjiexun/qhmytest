...
<html>
  ...
  <body>
   ...
   <div class="form-inline">
			<input type="text" class="form-control jf_FltConditions" id="keyWord" style="width:18%;" placeholder="美院名称" maxlength="25"/>
   ...
   <table class="table table-striped table-hover table-border jf_table" id="poorTable" style="text-align: center;">
  	...
  	<script type="text/javascript" src="${basepath}static/js/myjs/meiDepIndex.js"></script>
