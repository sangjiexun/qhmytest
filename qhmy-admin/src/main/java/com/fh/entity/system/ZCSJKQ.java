...
public class ZCSJKQ implements Serializable{
	
	private static final long serialVersionUID = 3590364934083021281L;
	private String PKID;
	...
	public String toString() {
		return "ZCSJKQ [PKID=" + PKID + ", QIYE_BIANMA=" + QIYE_BIANMA
				+ ", PROJECT_BIANMA=" + PROJECT_BIANMA + ", STARTDATE="
				+ STARTDATE + ", ENDDATE=" + ENDDATE + ", ZAIGONGYXSJ="
				+ ZAIGONGYXSJ + ", CJSJ=" + CJSJ + ", XGSJ=" + XGSJ
				+ ", ZHUANGTAI=" + ZHUANGTAI + ", ZUOFEISHJIAN=" + ZUOFEISHJIAN
				+ ", GROUPID=" + GROUPID + ", QIANHOUSJ=" + QIANHOUSJ + "]";
	}
