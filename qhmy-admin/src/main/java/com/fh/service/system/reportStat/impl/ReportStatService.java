package com.fh.service.system.reportStat.impl;
...
public class ReportStatService implements ReportStatManager {
	@Resource(name = "daoSupport")
	private DaoSupport dao;

	@Override
	public List<PageData> paySumTablelistPage(Page page) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.paySumTablelistPage", page);
	}

	@Override
	public List<PageData> paySumDetailTablelistPage(Page page) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.paySumDetailTablelistPage", page);
	}

	@Override
	public List<PageData> getListItem(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.getListItem", pd);
	}

	@Override
	public List<VO> departmentList(PageData pd) throws Exception {
		return (List<VO>) dao.findForList("reportStatMapper.departmentList", pd);
	}

	@Override
	public List<PageData> getGrades(PageData pd) throws Exception {
		return (List<PageData> )dao.findForList("reportStatMapper.getGrades", pd);
	}

	@Override
	public List<PageData> getPayMsg(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.getPayMsg", pd);
	}

	@Override
	public List<PageData> paySumDetailTablelist(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.paySumDetailTablelist", pd);
	}

	@Override
	public List<PageData> payDetailTablelistPage(Page page) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.payDetailTablelistPage", page);
	}

	@Override
	public List<PageData> jieshaorenSumTablelistPage(Page page) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.jieshaorenSumTablelistPage", page);
	}

	@Override
	public List<PageData> getZuzhis(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.getZuzhis", pd);
	}

	@Override
	public List<PageData> jieshaorenDetailTablelistPage(Page page)
			throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.jieshaorenDetailTablelistPage", page);
	}

	@Override
	public List<PageData> jieshaorenDetailTablelist(PageData pd)
			throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.jieshaorenDetailTablelist", pd);
	}

	@Override
	public List<PageData> jieshaorenSumTablelist(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.jieshaorenSumTablelist", pd);
	}

	@Override
	public List<PageData> getFeeSumlistTable(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.getFeeSumlistTable", pd);
	}

	@Override
	public List<PageData> getlistDep(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.getlistDep", pd);
	}

	@Override
	public List<PageData> getFeeDetailTablelistPage(Page page) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.getFeeDetailTablelistPage", page);
	}

	@Override
	public List<PageData> getFeeDetailTablelist(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.getFeeDetailTablelist", pd);
	}

	@Override
	public List<PageData> getListItemBL(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.getListItemBL", pd);
	}

	@Override
	public List<PageData> getPd_msg(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.getPd_msg", pd);
	}

	@Override
	public List<PageData> getStu_msg(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		PageData pd_all = (PageData)dao.findForObject("reportStatMapper.getStu_msg_all", pd);
		PageData pd_owe = (PageData)dao.findForObject("reportStatMapper.getStu_msg", pd);
	...
	public PageData getAmountMsgFeeDetial(PageData pd) throws Exception {
		return (PageData)dao.findForObject("reportStatMapper.getAmountMsgFeeDetial", pd);
	}

	@Override
	public List<PageData> getCollegeSummaryTableListPage(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.getCollegeSummaryTableListPage", pd);
	}

	@Override
	public List<PageData> getYuanXiao(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.getYuanXiaoList", pd);
	}

	@Override
	public List<PageData> getSuShersList(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>)dao.findForList("reportStatMapper.getSuShersList", pd);
	}

	@Override
	public PageData getdepartList(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (PageData)dao.findForObject("reportStatMapper.getdepartList", pd);
	}

	@Override
	public List<PageData> sushelist(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>)dao.findForList("reportStatMapper.sushelist", pd);
	}
	
	@Override
	public PageData getdepartListCj(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (PageData)dao.findForObject("reportStatMapper.getdepartListCj", pd);
	}

	@Override
	public List<PageData> getYuanXiaoLists(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>)dao.findForList("reportStatMapper.getYuanXiaoLists", pd);
	}
	...
	public List<PageData> getStudentDormPlanSumTable2(PageData pd) throws Exception {
		 ...
		 * 获得院校专业列表
		 */
		List<PageData> departmentList = (List<PageData>)dao.findForList("reportStatMapper.getDepartmentList", pd);
		...
		if(departmentList != null && departmentList.size() > 0){
			...
			for(PageData department : departmentList){
				...
				//获得指定学院下表格数据
				List<PageData> studentDormPlanSumList = (List<PageData>)dao.findForList("reportStatMapper.getStudentDormPlanSumTableList", pd);
	...
	public List<PageData> getTheInvoicingList(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.getTheInvoicingList", pd);
	}

	@Override
	public List<PageData> getOperatorList(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("reportStatMapper.getOperatorList", pd);
	}
	...
	public List<PageData> getRuxuenianfenList(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>)dao.findForList("reportStatMapper.getRuxuenianfenList", pd);
	}

	@Override
	public List<PageData> getBanxingList(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>)dao.findForList("reportStatMapper.getBanxingList", pd);
	}

	@Override
	public List<PageData> getJiaofeileixingList(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>)dao.findForList("reportStatMapper.getJiaofeileixingList", pd);
	}
