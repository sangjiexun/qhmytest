package com.fh.service.system.school_enrollment_statistics_report.impl;
...
/**
 * 
 * <p>标题:ReportStatService</p>
 * <p>描述:报表统计实现类</p>
 * <p>组织:河北科曼信息技术有限公司</p>
 * @author wn 王宁
 * @date 2017年8月14日 下午4:38:55
 */
@Service("school_enrollment_statistics_reportService")
public class School_enrollment_statistics_reportService implements School_enrollment_statistics_reportMapper {
	@Resource(name = "daoSupport")
	private DaoSupport dao;

	@Override
	public List<PageData> paySumTablelistPage(Page page) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.paySumTablelistPage", page);
	}

	@Override
	public List<PageData> paySumDetailTablelistPage(Page page) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.paySumDetailTablelistPage", page);
	}

	@Override
	public List<PageData> getListItem(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getListItem", pd);
	}

	@Override
	public List<VO> departmentList(PageData pd) throws Exception {
		return (List<VO>) dao.findForList("school_enrollment_statistics_reportMapper.departmentList", pd);
	}

	@Override
	public List<PageData> getGrades(PageData pd) throws Exception {
		return (List<PageData> )dao.findForList("school_enrollment_statistics_reportMapper.getGrades", pd);
	}

	@Override
	public List<PageData> getPayMsg(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getPayMsg", pd);
	}

	@Override
	public List<PageData> paySumDetailTablelist(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.paySumDetailTablelist", pd);
	}

	@Override
	public List<PageData> payDetailTablelistPage(Page page) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.payDetailTablelistPage", page);
	}

	@Override
	public List<PageData> jieshaorenSumTablelistPage(Page page) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.jieshaorenSumTablelistPage", page);
	}

	@Override
	public List<PageData> getZuzhis(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getZuzhis", pd);
	}

	@Override
	public List<PageData> jieshaorenDetailTablelistPage(Page page)
			throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.jieshaorenDetailTablelistPage", page);
	}

	@Override
	public List<PageData> jieshaorenDetailTablelist(PageData pd)
			throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.jieshaorenDetailTablelist", pd);
	}

	@Override
	public List<PageData> jieshaorenSumTablelist(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.jieshaorenSumTablelist", pd);
	}

	@Override
	public List<PageData> getFeeSumlistTable(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getFeeSumlistTable", pd);
	}

	@Override
	public List<PageData> getlistDep(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getlistDep", pd);
	}

	@Override
	public List<PageData> getFeeDetailTablelistPage(Page page) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getFeeDetailTablelistPage", page);
	}

	@Override
	public List<PageData> getFeeDetailTablelist(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getFeeDetailTablelist", pd);
	}

	@Override
	public List<PageData> getListItemBL(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getListItemBL", pd);
	}

	@Override
	public List<PageData> getPd_msg(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getPd_msg", pd);
	}

	@Override
	public List<PageData> getStu_msg(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		PageData pd_all = (PageData)dao.findForObject("school_enrollment_statistics_reportMapper.getStu_msg_all", pd);
		PageData pd_owe = (PageData)dao.findForObject("school_enrollment_statistics_reportMapper.getStu_msg", pd);
	...
	public PageData getAmountMsgFeeDetial(PageData pd) throws Exception {
		return (PageData)dao.findForObject("school_enrollment_statistics_reportMapper.getAmountMsgFeeDetial", pd);
	}

	@Override
	public List<PageData> getCollegeSummaryTableListPage(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getCollegeSummaryTableListPage", pd);
	}

	@Override
	public List<PageData> getYuanXiao(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getYuanXiaoList", pd);
	}

	@Override
	public List<PageData> getSuShersList(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getSuShersList", pd);
	}

	@Override
	public PageData getdepartList(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (PageData)dao.findForObject("school_enrollment_statistics_reportMapper.getdepartList", pd);
	}

	@Override
	public List<PageData> sushelist(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.sushelist", pd);
	}
	
	@Override
	public PageData getdepartListCj(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (PageData)dao.findForObject("school_enrollment_statistics_reportMapper.getdepartListCj", pd);
	}

	@Override
	public List<PageData> getYuanXiaoLists(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getYuanXiaoLists", pd);
	}
	...
	public List<PageData> getStudentDormPlanSumTable2(PageData pd) throws Exception {
		 ...
		 * 获得院校专业列表
		 */
		List<PageData> departmentList = (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getDepartmentList", pd);
		...
		if(departmentList != null && departmentList.size() > 0){
			...
			for(PageData department : departmentList){
				...
				//获得指定学院下表格数据
				List<PageData> studentDormPlanSumList = (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getStudentDormPlanSumTableList", pd);
	...
	public List<PageData> getTheInvoicingList(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getTheInvoicingList", pd);
	}

	@Override
	public List<PageData> getOperatorList(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getOperatorList", pd);
	}
	...
	public List<PageData> getRuxuenianfenList(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getRuxuenianfenList", pd);
	}

	@Override
	public List<PageData> getBanxingList(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getBanxingList", pd);
	}

	@Override
	public List<PageData> getJiaofeileixingList(PageData pd) throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>)dao.findForList("school_enrollment_statistics_reportMapper.getJiaofeileixingList", pd);
	}
